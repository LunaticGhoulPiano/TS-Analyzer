//! Isolated H.265 / 188-byte appsrc throughput experiment, not the production player.
//! Use `seek_probe` or the player integration tests for production seek behavior.
